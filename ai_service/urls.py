...
from .views import (
    ...
    ExpenseModelAnalysisView,
    ExpenseModelConfigView,
...
urlpatterns = [
    ...
    path('expense/analyze/', ExpenseModelAnalysisView.as_view(), name='expense-analyze'),
    path('expense/config/', ExpenseModelConfigView.as_view(), name='expense-config'),
